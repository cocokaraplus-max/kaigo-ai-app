...
- fix: ボタンデザインを3色に整理・スタイリッシュに (2026-04-09)
- feat: ボタンを青グラデーションに変更 (2026-04-09)
- feat: TOPボタンにカラーデザイン追加 (2026-04-09)
- fix: ロゴをbase64で中央表示に変更 (2026-04-09)
- fix: ロゴを中央寄せに修正 (2026-04-09)
- fix: ロゴ中央寄せ・文字色修正 (2026-04-09)
- fix: style.cssを青系デザインに更新 (2026-04-09)
- fix: style.css更新・CSS読み込み確認 (2026-04-09)
- feat: 青系プロデザインに刷新 (2026-04-09)
- fix: Cloud Run環境変数対応 (2026-04-09)
