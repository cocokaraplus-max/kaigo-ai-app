...
- fix: 利用者管理ボタンを横並びに修正 (2026-04-10)
- fix: スマホでボタンを横並びに強制 (2026-04-10)
- fix: ダークモード強制無効化・exception修正 (2026-04-10)
- fix: ライトモード強制・ボタンをコンパクトに (2026-04-10)
- feat: ダーク・ライト両対応のユニバーサルデザインに変更 (2026-04-10)
- fix: スマホダークモード文字色を強制修正 (2026-04-10)
