...
**本番へ出していないもの（DEVには入っている・DBの変更なし）**

| marker | 中身 | 確認 |
|---|---|---|
| `renraku-save-before-v1` | 送る前・刷る前に保存する | 実機で印刷OK |
| `renraku-line-vis-media-v1` | 写真・動画にトグルを効かせる | 一部OK |
| `renraku-line-vis-media-v2` | 送るもの・送らないものを両方出す | ★未確認 |
| `pay-verify-v1` | 勤怠を検算できる形にする | ★未確認 |
